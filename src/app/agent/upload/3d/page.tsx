...
export default function AgentUpload3DPage() {
  ...
  const goToReview = useCallback((skip3D: boolean = false) => {
    ...
    const draft = {
      ...
      location: [step1Data.form.address?.trim(), step1Data.form.city?.trim()].filter(Boolean).join(', '),
      specs: {
        bedrooms: step1Data.form.bedrooms ? Number(step1Data.form.bedrooms) : 0,
        bathrooms: step1Data.form.bathrooms ? Number(step1Data.form.bathrooms) : 0,
